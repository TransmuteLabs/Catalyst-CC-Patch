...
`claude-patch-all.sh` — 119 (docnum:historical; all green on the built image). As of 2026-08-22 the judging mechanism
...
2. 130/130 checks must pass; any `fail` — read the locator, do not work
