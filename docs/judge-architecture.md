...
`claude-patch-all.sh` — 119 (all green on the built image). As of 2026-08-22 the judging mechanism
...
2. 119/119 checks must pass; any `fail` — read the locator, do not work
