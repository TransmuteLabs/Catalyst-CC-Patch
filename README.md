...
installed if any one of the pipeline's 117 checks fails, and the switch to a new build
...
probe bench, any of the pipeline's 117 checks) leaves the live installation
...
## What the patches do (117 pipeline checks)
