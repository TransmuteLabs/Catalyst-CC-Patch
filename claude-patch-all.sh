...
# 650a03f: src/systemPromptSync.ts, displaySyncResults), когда накладка
...
__tw_check_prompt_conflicts() {   # <вывод tweakcc> <образ> -> 0|1
  local __out="$1" __bin="$2"
  local __ver __conf __outage __outage_dl
...
CATALYST_TWEAKCC_SHA="${CATALYST_TWEAKCC_SHA:-650a03f14a4c460cc5f3f4d06c1397aa4dc1668b}"
