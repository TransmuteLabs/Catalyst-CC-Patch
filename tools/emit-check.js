...
// Якорь-КОММЕНТАРИЙ этого свойства не имеет: перенос комментария в другое
// место файла оставляет проверку без куска, а выход 2 незаметен, пока её
// никто не зовёт. Оба раза так и случилось.
const parts = [
