...
Коды выхода (подмножество общей таблицы кита -- см. шапку claude-patch-all.sh):
  ...
  2  прибор не может мерить: нет таблицы, строка не о пяти полях, якорь гейта
     пропал или встречается не один раз, ПРИСТИННЫЙ кит уже красный (контроль
     провален, и мутация ничего не докажет), либо выведенный из пути корень
     не несёт подписи кита (круг 24)
