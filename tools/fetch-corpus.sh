...
# Недокачанный образ убирается на любом выходе: `.part.XXXXXX` лежит в ЖИВОМ
# корпусе (вне дерева), прополки у корпуса нет, и убитая закачка копила мусор
# без предела (раунд 19, В-11).
