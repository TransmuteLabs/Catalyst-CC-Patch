...
step('22 judge consulted before a subagent dispatch', () => {
  ...
  const judge =
    ...
    'try{' +
      ...
      //     это молча потерянное распоряжение;
      ...
      // (3) счёт по числам, а не повторной сериализацией (прежняя редакция была
      //     квадратичной: 4800 записей — 8.3 с при пороге ступени 25 с);
      // (4) незакреплённая запись, удаление которой увело бы ленту НИЖЕ бюджета,
      //     укорачивается под зазор — иначе лента обнулялась, а судья выносил
      //     обычный вердикт вслепую;
      // (5) все пороги считаются в ДЛИНЕ JSON, а не текста: экранирование
      //     раздувает управляющий символ в шесть знаков, и текстовые пороги
      //     промахивались в обе стороны — переполнение бюджета на границе и
      //     недобор до 8% использования на экранируемом содержимом. Резерв под
      //     маркер тоже не угадывается: маркер добавляется последним и лента
      //     ужимается ровно на его цену.
      'let __cut=(__n)=>{' +
        ...
        'let __fit=(__i,__tc)=>{if(__w[__i]<=__tc)return 0;' +
          'let __t=String(__a[__i].text),__lim=Math.max(8,__tc-60),__nx=null,__c=0;' +
        ...
        'let __long=(__f)=>{let __i=-1,__L=-1;for(let __k=0;__k<__a.length;__k++)' +
          'if(__f(__a[__k])&&__w[__k]>__L){__L=__w[__k];__i=__k}return __i};' +
        ...
        'let __cap=(__f,__lim)=>{let __s1=__sum(__f);' +
          'for(let __g=0;__g<20000&&__s1>__lim;__g++){' +
            ...
            'if(__w[__i]>240){let __gg=__fit(__i,Math.max(120,__w[__i]-(__s1-__lim)));' +
        ...
        'for(let __k=0;__k<__a.length&&__tot>__b;){' +
          ...
          'if(__w[__k]>120){__fit(__k,__w[__k]-(__tot-__b));__k++;continue}' +
          '__del(__k,!1)}' +
        ...
        // Он же добавляется ПОСЛЕДНИМ и оплачивается ужиманием ленты на свою
        // фактическую цену — угаданный резерв на малых бюджетах не сходился.
        'if(__d>0||__c2>0){' +
          'let __mt=()=>"[\\u043b\\u0435\\u043d\\u0442\\u0430 \\u043f\\u043e\\u0434\\u0440\\u0435\\u0437\\u0430\\u043d\\u0430: \\u0432\\u044b\\u0442\\u0435\\u0441\\u043d\\u0435\\u043d\\u043e "+__d+" \\u0437\\u0430\\u043f\\u0438\\u0441\\u0435\\u0439; \\u0437\\u0430\\u043a\\u0440\\u0435\\u043f\\u043b\\u0435\\u043d\\u043e \\u0440\\u0435\\u043f\\u043b\\u0438\\u043a \\u0447\\u0435\\u043b\\u043e\\u0432\\u0435\\u043a\\u0430: "+__cnt(__isu)+", \\u0440\\u0435\\u0437\\u044e\\u043c\\u0435 \\u043a\\u043e\\u043c\\u043f\\u0430\\u043a\\u0446\\u0438\\u0438: "+__cnt(__iss)' +
            '+(__dp?"; \\u0412\\u042b\\u0422\\u0415\\u0421\\u041d\\u0415\\u041d\\u041e \\u0417\\u0410\\u041a\\u0420\\u0415\\u041f\\u041b\\u0401\\u041d\\u041d\\u042b\\u0425: "+__dp:"")+(__c2?"; \\u043f\\u043e\\u0434\\u0440\\u0435\\u0437\\u0430\\u043d\\u043e \\u043f\\u043e \\u0442\\u0435\\u043a\\u0441\\u0442\\u0443: "+__c2:"")+"]";' +
        // На крошечном бюджете подробный маркер сам не помещается (его цена
        // сопоставима со всей лентой), и обещание «лента не выше бюджета»
        // ломалось именно на нём. Тогда печатается краткая форма.
          ...
          'for(let __g=0;__g<20000&&__tot+__mc>__n&&__a.length>0;__g++){' +
            ...
            'if(__a.length<=1&&!__fit(0,Math.max(24,__n-__mc-4)))break;' +
            'if(__a.length>1)__del(0,__pr(__a[0]))}' +
