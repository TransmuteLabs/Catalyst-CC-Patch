...
step('22 judge consulted before a subagent dispatch', () => {
  ...
  const core =
    ...
    'try{' +
      ...
      // произведение: шесть файлов по 30000 — это 180000 знаков в нагрузке
      // одной консультации.
      //
      // Числа выбраны замером, а не на глаз (Catalyst-Judge-Eval, 500 живых
      // записей): при потолке в 2 файла бриф накрыт у 110 диспатчей из 132,
      // при 6 файлах и 30000 на файл — у 132 из 132; медиана приложенного
      // 30000 знаков, девятая дециль 66000. Умолчание ядра — НОЛЬ:
      ...
      'let __atb=__num("attach_total",__cfg.attach_total,120000,0);' +
      'let __att=[];' +
